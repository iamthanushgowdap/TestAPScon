        ...
        <div className="p-4 sm:p-6 lg:p-8 space-y-8">
            <div>
                ...
                <p className="text-muted-foreground mt-1">
                    Manage timetables for your assigned branches and semesters.
                </p>
            </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Choose from your assigned branches and semesters.</CardDescription>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
                        {loadingFaculty ? <Skeleton className="h-10 w-full" /> : (
                            <Select onValueChange={setSelectedBranch} value={selectedBranch} disabled={!facultyData?.branch?.length}>
                                <SelectTrigger>
                                    <SelectValue placeholder="Select Your Branch" />
                                </SelectTrigger>
                                <SelectContent>
                                    {facultyData?.branch?.map(branch => (
                         ...
                         {loadingFaculty ? <Skeleton className="h-10 w-full" /> : (
                            <Select onValueChange={setSelectedSemester} value={selectedSemester} disabled={!facultyData?.semesters?.length}>
                                <SelectTrigger>
                                    <SelectValue placeholder="Select Your Semester" />
                                </SelectTrigger>
                                <SelectContent>
                                    {facultyData?.semesters?.map(sem => (
