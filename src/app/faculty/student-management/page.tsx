...
export default function StudentManagementPage() {
    ...
    useEffect(() => {
        const sourceData = activeTab === 'all' ? allStudents : pendingStudents;
        const results = sourceData.filter(s =>
    ...
    const handleApproval = async (id: string, newStatus: 'approved' | 'declined') => {
        ...
        try {
            ...
            toast({
                ...
                description: `The student has been successfully ${newStatus}.`,
            });
        } catch (error) {
            console.error("Error updating status: ", error);
            toast({ title: "Error", description: "Failed to update student status. You may not have permission.", variant: "destructive" });
        }
    };
    ...
    const PendingStudentsView = () => (
         <>
            ...
            {filteredPendingStudents.length === 0 && <div className="text-center text-muted-foreground py-8">No students are currently pending approval.</div>}
        </>
    );
        ...
        <div className="p-4 sm:p-6 lg:p-8 space-y-8">
            <div>
                ...
                <p className="text-muted-foreground mt-1">
                    View students and manage pending approvals for your branch(es).
                </p>
            </div>
