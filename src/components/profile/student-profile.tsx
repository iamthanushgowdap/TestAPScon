                    ...
                    <Card className="glassmorphism">
                        <CardContent className="pt-6 flex flex-col items-center text-center">
                            <Avatar className="w-24 h-24 mb-4 border-2 border-primary">
                                <AvatarImage src="https://picsum.photos/202/202" alt="Tanushree" data-ai-hint="person student" />
                            ...
                            <h2 className="text-2xl font-bold font-headline">Tanushree</h2>
                            <p className="text-muted-foreground">1AP23CS001</p>
                        ...
                        <CardContent className="space-y-4">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <Input id="firstName" defaultValue="Tanushree" />
                                </div>
                                <div className="space-y-2">
                             ...
                             <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <Input id="branch" defaultValue="Computer Science" readOnly />
                                </div>
                                <div className="space-y-2">
                                    <Label htmlFor="year">Year</Label>
                                    <Input id="year" defaultValue="2nd Year" readOnly />
                                </div>
                            </div>
